//
//  ShortInfoRSSFeedViewController.swift
//  RSSPro
//
...
class ShortInfoRSSFeedViewController: UIViewController, RSSFeedViewProtocol
{
...
extension ShortInfoRSSFeedViewController: UITableViewDataSource
{
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: ShortInfoRSSFeedCell.className,
                                                 for: indexPath) as! ShortInfoRSSFeedCell
